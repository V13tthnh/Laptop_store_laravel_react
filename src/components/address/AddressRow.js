        ...
        <div className="colright view_address">
          ...
          <div className="line">
            <p className="address1">
              {data.address_detail}, {data.ward},{" "}
              {data.district}, {data.provinces}, Việt Nam
            </p>
          </div>
        </div>
        <div className="colleft">
          <div className="address_actions">
            ...
            <span className="action_delete">
              <Button style={{ color: "red" }} onClick={handleDeleteAddress} value={data.id} className="js-delete-customer">
                Xoá
              </Button>
            </span>
