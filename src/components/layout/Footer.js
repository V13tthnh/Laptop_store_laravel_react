              ...
              <div className="row">
                <div className="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                  <div className="li-shipping-inner-box">
                    <div className="shipping-icon">
                      <img
                        src="../../assets/images/shipping-icon/1.png"
                        alt="Shipping Icon"
                      />
                    </div>
                ...
                <div className="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                  <div className="li-shipping-inner-box">
                    <div className="shipping-icon">
                      <img
                        src="../../assets/images/shipping-icon/2.png"
                        alt="Shipping Icon"
                      />
                    </div>
                    <div className="shipping-text">
                ...
                <div className="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                  <div className="li-shipping-inner-box">
                    <div className="shipping-icon">
                      <img
                        src="../../assets/images/shipping-icon/3.png"
                        alt="Shipping Icon"
                      />
                    </div>
                    <div className="shipping-text">
                      ...
                      <p>
                        Bảo vệ quyền lợi mua hàng của bạn từ lúc nhấp chuột đến
                        lúc nhận hàng..
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                  <div className="li-shipping-inner-box">
                    <div className="shipping-icon">
                      <img
                        src="../../assets/images/shipping-icon/4.png"
                        alt="Shipping Icon"
                      />
                    </div>
                    <div className="shipping-text">
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6">
                  <div className="footer-logo">
                    <img
                      src="../../assets/images/menu/logo/1.jpg"
                      alt="Footer Logo"
                    />
                    <p className="info">
                      Đồ án tốt nghiệp website bán laptop.
                    </p>
                  </div>
                  <ul className="des">
                    <li>
                ...
                <div className="col-lg-4">
                  <div className="footer-block">
                    <h3 className="footer-block-title">Kết nối với chúng tôi</h3>
