  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/account/order/detail/:id" element={<OrderDetailPage/>}></Route> 
        ...
        <Route path="/auth/callback/facebook" element={<FacebookCallback />}></Route>

        <Route path="/register" element={<RegisterPage/>}></Route> 
        <Route path="/forgot-password" element={<ForgotPasswordPage/>}></Route>
        <Route path="/password-reset/:token" element={<ResetPasswordPage/>}></Route>
